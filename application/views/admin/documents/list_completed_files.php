                    ...
                    <div class="col-lg-3 col-xl-2">
                      <div class="file-man-box">
                        ...
                        <div class="file-img-box pdf-file-img-box">
                          ...
                          <a class="folder-icon " title="<?= $file->file_name ?>" target="_blank" href="<?= base_url('assets/signatures_completed/' . $file->file_name) ?>"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
                        </div>
