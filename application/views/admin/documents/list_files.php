        ...
        <div class="row">
          <div class="col-12">
            <div class="card-box">
              ...
              <div class="row mb-2">
                <div class="col-md-12">
                  <h4 class="header-title m-b-30 float-left">My Uploads</h4>
                  <a href="<?= base_url('admin/upload_documents/add_files/' . $folderId) ?>" class="btn btn-warning float-right add-new-file-btn">Add new files</a>
                </div>
              </div>
              <div class="row">
                  ...
                  <?php foreach ($pdfFiles as $idx => $file) : ?>
                    <div class="col-lg-3 col-xl-2">
                      <div class="file-man-box">
                        <a onclick="return confirm('are you sure to delete?')" href="<?= base_url('admin/upload_documents/delete_file/' . ($file->file_id * 786)) ?>" title="delete" class="file-close">
