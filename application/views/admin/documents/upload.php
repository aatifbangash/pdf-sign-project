      ...
      <div class="card card-default">
        ...
        <div class="card-body">
           ...
           <!-- For Messages -->
            ...
            <?php echo form_open_multipart( base_url('admin/upload_documents/upload'), 'id="upload_form"'); ?>
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                  <!-- /.card-header -->
                  ...
                  <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="company_name" class="form-control" id="company_name" value="<?php echo $this->session->flashdata('company_name'); ?>" placeholder="Folder name here..." >
                      </div>
                      
                      <div class="form-group">
                        <label for="address1" class="control-label"><?= trans('address_line') ?></label>
                        <input type="text" name="address1" class="form-control" id="address1" value="<?php echo $this->session->flashdata('address1'); ?>" placeholder="Address here..." >
                      </div>

                      <div class="form-group">
                        <label for="email" class="control-label"><?= trans('email') ?></label>
                        <input type="email" name="email" class="form-control" id="email" value="<?php echo $this->session->flashdata('email'); ?>" placeholder="Email here..." >
                      </div>
                      <div class="form-group">
                        <label for="mobile_no" class="control-label"><?= trans('mobile_no') ?></label>
                        <input type="number" name="mobile_no" class="form-control" id="" value="<?php echo $this->session->flashdata('mobile_no'); ?>" placeholder="Mobile number here..." >
                      </div>
                      <div class="form-group">
                      ...
                      <div class="col-md-12">
                        <select name="capture_role" class="form-control">
                          ...
                          <?php foreach($records as $role): ?>
                            <option value="<?= $role->user_id; ?>" <?php echo ($role->user_id == $this->session->flashdata('capture_role')) ? 'selected' : '' ?> ><?= $role->username; ?></option>
                          <?php endforeach; ?>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="row" >
                      <div class="col-md-12">
                        <img id="sig-image" style="<?php echo ($this->session->flashdata('signature_dataurl') ? 'display:block;' : 'display:none;') ?>" src="<?php echo $this->session->flashdata('signature_dataurl') ?>" class="signature-preview" alt="e-signature preview here!"/>
                      </div>
                    </div> -->
